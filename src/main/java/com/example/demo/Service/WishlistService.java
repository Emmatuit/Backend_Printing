...
public class WishlistService {
	...
	public List<WishlistItemDto> getWishlist(String email, String sessionId) {
		List<WishlistItem> items = email != null ? wishlistRepository.findByUserEmail(email)
	...
	public void mergeSessionWishlistWithUser(String email, String sessionId) {
		...
		Set<Long> userProductIds = userWishlistItems.stream().map(item -> item.getProduct().getId())
